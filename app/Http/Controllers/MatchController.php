...
if(($match->user_id != $user_id) &&  !(Chat::where('owner_user_id',$user_id)->where('guest_user_id',$match->user_id)->rWhere('owner_user_id',$match->user_id)->where('guest_user_id',$user_id)->first()){
